...
class ProductRegisterPage extends StatefulWidget {
  ...
  @override
  State<ProductRegisterPage> createState() => _ProductFormPageState();
}

class _ProductFormPageState extends State<ProductRegisterPage> with SnackBarMixin {
  ...
  void didChangeDependencies() {
    ...
    if (_formData.isEmpty) {
      ...
      if (arg != null) {
        final product = arg as ProductEntity;
